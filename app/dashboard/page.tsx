 ...
 * Three-column layout: conversation list | thread view | patient details.
...
export default function DashboardPage() {
    ...
    // ── Unique intents for selected patient ────────────────────
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {loadingPatients ? (
                            ...
                            filtered.map((patient) => {
                                ...
                                const colour =
                                    INTENT_COLOURS[patient.lastIntent as Intent] ??
                                    "#9CA3AF";
                    ...
                    {selected ? (
                        <>
                            ...
                            <div className="px-4 py-3 border-b border-[#E5E7EB]">
                                ...
                                >
                                    First contact:{" "}
                                    {new Date(selected.firstContactAt).toLocaleDateString(
                                        "en-GB",
                ...
                >
                    {selected ? (
                        <div className="p-4 space-y-4">
                            {/* Header */}
                            <p
                                className="text-[14px] font-bold text-[#111827] uppercase tracking-widest"
                            >
                                Patient Details
                            </p>
                            ...
                            <button
                                ...
                                style={{
                                    backgroundColor: sendingBooking
                                        ? "#1D4ED8"
                                        : "#2563EB",
                                    borderRadius: 4,
                                }}
